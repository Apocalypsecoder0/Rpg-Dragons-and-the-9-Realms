...
skill = []
spellschool = ["Abjuration", "Alteration/Transmutation", "Conjuration/Summoning", "Diviation", "Enchantment/Charm", "Invocation", "Illusion/Phantasm", "Necromancy"]
spelltype = ["normal", "fighting", "flying", "poison", "ground", "rock", "bug", "ghost", "steel", "fire", "water", "grass", "electric", "psychic", "ice", "dragon", "fairy", "dark]
spellname = []
raceclass = ["Human", "Orc", "Half-orc", "Half-elf", "Elf", "Gnome", "Dwarf", "Dragon-Born", "Bloodelf"]
play_transformation = ["Vimpire", "Werewolf", "Hybrid"]
mount = 
flying_mount = 
player_class ["Warrior", "Mage", "Paladin", "Hunter", "Priest", "Rogue", "Shaman", "Druid", "Warlock", "DeathKinght", "Monk", "Necromancer"]
champion = []
inventory = []
character = []
effectiveness = ["normal", "fighting", "flying", "poison", "ground", "rock", "bug", "ghost", "steel", "fire", "water", "grass", "electric", "psychic", "ice", "dragon", "fairy", "dark]
resistance = ["normal", "fighting", "flying", "poison", "ground", "rock", "bug", "ghost", "steel", "fire", "water", "grass", "electric", "psychic", "ice", "dragon", "fairy", "dark]
weakness = ["normal", "fighting", "flying", "poison", "ground", "rock", "bug", "ghost", "steel", "fire", "water", "grass", "electric", "psychic", "ice", "dragon", "fairy", "dark"]
shop_spell = []

# List of items to be used in the game, from line 5 - 130
shop_armors = ["clothes -worth 50g", "leather armor - worth 40g", "chain mail -woth 300g", "half plate -worth 1000"
"full plate -worth 3000g", "magic armor -worth 7700g",]
shop_shields = ["leather shield - worth 90g", "iron shield - worth 800g", "silver shield -worth 14800g"]
  shop_weapons = ["club -worth 60g", "copper sword -worth 180g",   "hand axy    -worth 560g",  "broad sword -worth 1500g",  
 "flame sword -worth 9800g"]
shop_items = ["Health Portion  - Worth 50g", "herbs -worth 24g", "torch -worth 8g", "dragonls scale -worth 20g", "wings -worth 70g","magic key -worth 53g", "fairy water -worth 38g" ] 
"Robes of Freya   - Worth 300g",  "Dress of a princess     - Worth 500g",
              "Glittering steel armour - Worth 400g",
              "A grand Tribute         - Not for sale",
              "A Talisman              - Worth 300g",
              "Jewellary               - Worth 400g",
              "Durandal,a mighty sword - Worth 600g",
              "Steel Helmet            - Worth 200g",
shop_special_items = ["erdrickls tablet", "ball of light - worth 1000g", "staff of rain -worth 125g", "fairty flute -worth 250g", 
"silver harp - 1250g", "gwaelinls love - 450g", "erdrickls token -worth 350g", "rainbow drop -500g"] 
shop_cursed_item = ["cursed belt  -worth 450", "cursed necklace -worth 450g" ]
shop_other_item = ["fighter's ring - worth 4500g"]
shop_erdrick's_item = ["erdrickls sword worth -15000g", "erdricks armor  -worth 1500g"]
                     "Go back to village      - None      "]
                     #item weapons list
                     onehands_list = ["one hand sword"]
                     twohands_list = ["two hand sword"]
                     rangs_weapons_list = ["bow," "crossbow", "longbow"]
                weapons_wight_list = ["light", "medium", "heavy"]
                #player items 
player_items = ["trusty dagger",
                "Steel armour"]
                
                #armor item list
               item_armorwight_list = ["light cloth", "medium leather", "heavy steel"]
                item_armor_list = ["steel armor", "leather armor", "cloth armor"]
                item_armorbody_list = ["head", "cheat", "legs", "feets", "hands", "shouder", "leftring", "rightring", "neck"]
item_weapons_list = ["sword", "spear", "axe", "crossbow", "warhammer", "dagger", "flail", "pike", "knife", "lance", "mace", "bow", "shields", "halberd", "longbow", "longsowrd", "rapier", "broudsowrd", "falchion", "armiagsword", "bludgeon", "morningstar", "katana"]
...
city_locations = ["inn", "traven", "city hall", "castle", "dungon", "village"]
village_locations = ["Traven",
                     ...
                     "Cave", "castle",
                     "Forest", "city"]
                    castle_info_day = ["INFO: Don't go into the castle un-prepared",
                "INFO: King of this country like presents",
                "INFO: Check out the contests at night too",
                "INFO: The castle is nest to stronger enemies",
                "INFO: castle is vast, explore out of options to "
                "find many things",
                "INFO: Did you know there is a legendary tomb in the castle?",
                "INFO: Animals in castle are faster than you, you got "
                "my point?"]
                    castle_info_night = ["INFO: castle at night is dark. You may need fire source",
                  "INFO: Did you know that the castle has a range "
                  "between 1 to 50",
                  "INFO: The princess of this country, likes flowers",
                  "INFO: check out the secreat contests at night",
                  "INFO: Do not pick a fight with enemies stronger than you",
                  ...
                  "Werewolves",
                  "INFO: Access to castle is restricted at night",
                  "INFO: Sneaking into castle at night time might "
                  "result in imprisonment",
                  "INFO: Having full health is always an advantage"]
                     SindriShop_locations = ["INFO: Sindrishop"]
                     BrokShop_locations = ["INFO: Brok shop"]
                     Sindri & Brok Shop_locations = ["INFO: Sindri & Brok Shop"]
                               
    zones_locations = ["test"]
    
    forbidden_locations = ["test"]
    
    worlds_locations = ["Great Hall of Asgard", "Great Hall of Midgard", "Great Hall of Jotunheim", "Great Hall of Svartalfheim"
"Great Hall of Vanaheim", "Great Hall of Muspelheim", "Great Hall of Niflheim", "Great Hall of Nidavellir", "Great Hall of Alfheim"]
    
    realms_locations = ["Midgard", "Asgard", "Jotunheim", "Svartalfheim"
"Vanaheim", "Muspelheim", "Niflheim", "Nidavellir", "Alfheim"]
    
    zone_regions_locations = ["North", "East", "South", "Weast"]
   
    zone_countries_locations = []
    
    zone_continets_locations = ["Alik'r Desert", "Artaeum", "Auridon", "Bal Foyen", "Bangkorai", "Betnikh", "Blackreach", "Arkthzand Cavern", "Blackwood", "Bleakrock Isle", "Clockwork City", "Coldharbour", "Craglorn", "Cyrodiil", "Deadlands", "Deshaan", "Eastmarch", "Elsweyr",  "Eyevea", "Glenumbra", "Gold Coast", "Grahtwood", "Greenshade", "Hew's Bane", "Imperial City", "Khenarthi's Roost", "Malabal Tor", "Murkmire", "Pellitine", "Reaper's March", "Rivenspire", "Shadowfen", "Southern", "Elsweyr", "Stonefalls", "Stormhaven", "Stros M'Kai", "Summerset", "The Reach", "The Rift", "Thieves Den", "Vvardenfell", "Western Skyrim", "Wrothgar"]
    
   kingdoms_locations = ["North Castle", "East Castle", "South Castle", "Weast Castle"]
    castle_locations_day = ["Library", "Tower", "Weapons&Armor Armory", "Brok shop", "Sindri shop",
                      "Quaters",
                      "Garden",
                      "Central Hall",
                      "Go back to Village", "Go back to city"]

    castle_location_night = ["Library",  "Tower", "Weapons&Armor Armory", "Brok shop", "Sindri shop",
                      "Quaters",
                      "Garden",
                      "Central Hall",
                      "Go back to Village", "Go back to city"]
mount_fast_travel = ["INFO: you are on horse back traveling to next zone"]
cart_fast_travel = ["INFO: you are on a bugy travel to next zone"]
mage_portal_fasttravel = ["INFO: you are opening a mage portal to the next zone"]
    dungons_locations = ["Dungonstest", "the withered crypt", "the smoldering caverns", "the twilight cells", "the fearsome vault" ]
    dungons = ["The Dread Cellar", "Red Petal Dungeon", "The Cauldron", "Black Drake Villa", "Stone Garden", "Castle Thorn", 
"Icereach", "Unhallowed Grave", "Lair of Maarselok", "Moongrave Fane", "Frostvault", "Depths of Malatar", "March of Sacrifices", 
"Scalecaller Peak", "Fang Lair", "Bloodroot Forge", "White Gold Tower", "Imperial City Prison", "Spindleclutch 1", "Spindleclutch 2", 
"Tempest Island", "City of Ash 1", "City of Ash 2", "Banished Cells 1", "Banished Cells 2", "Fungal Grotto 1", "Fungal Grotto 2", 
"Darkshade Caverns 1",  "Arx Corinium" ]
    trialdungons_locations = ["trialdungonstest", "lair of the scarlet queen", "the serene grotto", "the black forest maze", "the chaotic emperor"]
    trials = ["Aetherian Archive", "Asylum Sanctorium", "Cloudrest", "Halls of Fabricatin", "Hel Ra Citadel", "Kyne`s Agis", "Maw of Lorkhai", "Rockgrove", "Sanctum Ophidia", "Sunspire"]
arenas_locations = ["Black Rose Prison", "Dragonstar", "Maelstrom", "Vateshran Hollws"]
...
fort_locations_night = ["Library",
                        ...
                        "Garden",
                        "Central Hall"]
questrewards = ["Item", "Gold", "Key", "MysteryBox"]
...
## enemy trial, dungon and arena moves
enemytrial_offense_moves = ["The enemy charges at you like a mad bull",
...
enemytrial_defense_moves = ["Enemy has a strong defense",
...
enemydungon_offense_moves = ["The enemy charges at you like a mad bull",
                       "The enemy has a arm streangth of a boulder",
                       "Enemy has wits and great strategy to corner you",
                       "The enemy attacks from behind",
                       "The enemy rolls around and attacks from the side",
...
enemydungon_defense_moves = ["Enemy has a strong defense",
                       "Your enemy has brains to dodge your attacks",
                       "Your enemy has speed advantage to evade your attacks",
                       "Your enemy has a strength to with stand your attack",
                       "Enemy is determined to take you head on",
                       "Your enemy is a formidable opponent"]
enemyarena_offense_moves = ["The enemy charges at you like a mad bull",
                       "The enemy has a arm streangth of a boulder",
                       "Enemy has wits and great strategy to corner you",
                       "The enemy attacks from behind",
                       "The enemy rolls around and attacks from the side",
...
enemyarena_defense_moves = ["Enemy has a strong defense",
                       "Your enemy has brains to dodge your attacks",
                       "Your enemy has speed advantage to evade your attacks",
                       "Your enemy has a strength to with stand your attack",
                       "Enemy is determined to take you head on",
...
#animal, creature, and monster list
animal_list = ["Boar", "Bear", "Wolf", "bird"]

strong_animal_list = ["Leopard", "Tiger", "Werewolf"]
creature_list = ["dragon", "basilisk", "werewolf", "giant", "griffin", "vampire", "octopus", "centaur", "demon", "minotaur", "chimera", "spider", "manticore", "cyclops", "mammoth"]
monster_list = ["BARTENDER",
                "MINISTER",
                "SHOPKEEPER",
                "HOST of the contest grounds"]
                enemydungonboss_list = ["enemytest1"]
                enemytrialboss_list = ["enemytest1"]
                enemyarena_list = ["enemytest1"]
                npc_list = ["quest giver", "brok", "sindri"]
emenymonster_list = ["slimes", "drakees","ghosts","magicians","scropions","druins","skeletons","wolves","stoneman","wyverns","kinght","dragons","dragon lord"]
#item chests and rarity 
item_chests = ["wood chests", "steel chests", "epic chests", "legendary chests", "exoic chests", "mythical chests"]
item_rarity = ["uncommon", "common", "epic", "legendary", "exoic", "mythical"]
...
Brok&Sindrishop = 0
shop_items = "availble"
shop_weapons = "available"
shop_armor = "available"
...
Keyword_count = 0
inventory = 
castle_explore_count = 0
castle_trigger = "deactivate"
...
fort_count = 0
toll_status = ""
              inner_castle_count = 0
              castle_access = "restricted"
inner_fort_count = 0
...
event_tournament = 
 adventure_quest =
 adventure_quest_stats =                                                                                                                                                                                                           story_act =
        story_act_stats =                                                                                                                                                                             
dungon_key = 
trial_key =
item_dungonskey =
...
def remove_item(list, item):
    ...
    list = new_list
    return list
# function to increase player's mana within the limit of 100
def mana_increase(num):
    global player_mana
    if player_mana < 100 and player_mana > 0:
        player_mana += num
        if player_mana > 100:
            player_mana = 100
        return player_mana
...
# function to decrease player's mana within the threshold of 0
def mana_decrease(mana, num):
    if mana > 0:
        mana += num
        if mana < 0:
            mana = 0
        ...
        # function to increase player's stamana within the limit of 100
def stamana_increase(num):
    global player_stamana
    if player_stamana < 100 and player_stamana > 0:
        player_stamana += num
        if player_stamana > 100:
            player_stamana = 100
        return player_stamana


# function to decrease player's stamana within the threshold of 0
def stamana_decrease(stamana, num):
    if stamana > 0:
        stamana += num
        if stamana < 0:
            stamana = 0
...
# function to display a message whenever the crystal is insufficient
def low_crystal_message():
    global crystal
    global player
    print_pause("NOTE: You do not have enough cash " + player + "!")
    print_pause("Your Crystal : " + crystal)
    print_pause("NOTE: Try earning some in the town contest")
    # function to display a message whenever the metal is insufficient
def low_metal_message():
    global metal
    global player
    print_pause("NOTE: You do not have enough cash " + player + "!")
    print_pause("Your Metal : " + metal)
    print_pause("NOTE: Try earning some in the town contest")
...
def adventure_game():
    ...
    player = input("\nWhat is your name sir kinght?\n")
    print_pause("\nOn gaurd " + player + ".")
    print_pause("You are on an royal aventure to slay the mighty monster and creatures of the 9 realms of yggdrasil")
    village()
...
def village():
    ...
    # village intro
    # player's choice
    print_pause("\nWelcome to the fabled village of the realms")
    ...
    # if player decides to enter into the forest
        ...
        forest()
       # if player decides to enter into the castle
    elif "castle" in city_choice:
        forest()
...
def city():
    ...
    # city intro
    # player's choice
    print_pause("\nWelcome to the fabled city of the realms")
    print_pause("Where would you like to venture into:")
    # displays list of city locations in a serial list
    city_choice = input(list_serial(city_locations)).lower()
    # if player decides to enter into the traven
    if "traven" in city_choice:
        print_pause("\nYou have entered Traven to make business")
        shop()
    # if player decides to enter into the Inn
    elif "inn" in city_choice:
        print_pause("\nYou have checked into an Inn")
        inn()
    # if player decides to enter into the contest grounds
    elif "contest" in city_choice:
        print_pause("\nYou head towards the contest grounds with curiosity")
        contest_grounds()
    # if player decides to enter into the forest
    elif "forest" in city_choice:
        forest()
       # if player decides to enter into the castle
    elif "castle" in city_choice:
        forest()
            # if player decides to enter into the forest
    elif "village" in city_choice:
        village()
    # if player decides to enter into the cave
    elif "cave" in city_choice:
        print_pause("You step into the darkness of cave courageously !!")
        print_pause("The cave is a labyrinth of multiple partitions")
        cave()
    # if player decides to enter into the fort
    elif "fort" in city_choice:
        fort()
    # if player decides to enter into the secret passage
    elif "secret" in city_choice and "Secret Passage" in city_locations:
        secret_passage()
    # condition to deal with unrecognized input
    else:
        print_pause("The place you are looking for does not exist "
...
#########
# funtion to trigger Brokshop sequence in the game
def Brokshop():
    global gold
    global crystal
    global metal    
    global Brokshop_items
    global player_items
    global player
    global player_status
    global player_offense_min
    ...
    # A message to be displayed only if the player is wanted
        ...
        print_pause("SHOPKEEPER: But I am willing to keep this as a "
                    "secret between us")
    # A message to be used throughout the game, if player revisit the Brokshop
    else:
        print_pause("\nSHOPKEEPER: Welcome back " + player + " !!")
        print_pause("SHOPKEEPER: Back for more?")
        print_pause("SHOPKEEPER: Let me see if I can find, what you need.")
    ...
    print_pause("SHOPKEEPER: What do you want to purchase? Name it.")
    # Displays Brokshops items in a serial list and take desired input from player
    Brokshop_choice = input(list_serial(Brokshop_items)).lower()
    # if player wants to buy health potion in the Brokshop
    if "health" in Brokshop_choice:
        if gold >= 50 and player_health < 100:
            print_pause("SHOPKEEPER: One must stock up on health or face "
                        "certain death")
            print_pause("Gold: " + str(gold) + ", - 50")
            ...
            low_gold_message()
    # if player wants to buy 'freya dress' in the Brokshop
    # by adding /freya_dress == "available"/ in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "freya" in Brokshop_choice and freya_dress == "available":
        if gold >= 300:
            print_pause("SHOPKEEPER: A rare robe, legend has it's "
                        "been worn by Goddess freya herself !!\n")
            print_pause("Note: Now you have 'Robes of Freya' in your "
                        "possession")
            Brokshop_items = remove_item(Brokshop_items,
                                     "Robes of Freya          - Worth 300$")
            player_items.append("Robes of Freya")
            gift_items.append("Robes of Freya")
            freya_dress = "not available"
            ...
            low_gold_message()
    # if player wants to buy 'princess dress' in the Brokshop
    # by adding /princess_dress == "available"/ in below statement-
    # player cannot buy this item, if the item is already sold out
    elif "princess" in Brokshop_choice and princess_dress == "available":
        if gold >= 500:
            print_pause("SHOPKEEPER: A fine dress! " + player)
            print_pause("SHOPKEEPER: I guess it's not for you to wear. "
                        "Hmm., a gift perhaps!!")
            ...
            low_gold_message()
    # if player wants to buy 'steel armour' in the Brokshop
    # by adding / armour == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "armour" in Brokshop_choice and armour == "available":
        if gold >= 400:
            print_pause("SHOPKEEPER: Shiny shiny, makes enemies whiny tiny")
            print_pause("Note: Now you have 'Steel Armour' in your possession")
            Brokshop_items = remove_item(Brokshop_items,
            ...
            low_gold_message()
    # if player wants to buy 'talisman' in the Brokshop
    elif "talisman" in Brokshop_choice:
        if gold >= 300:
            print_pause("SHOPKEEPER: I see you are in serious "
                        "business " + player)
            print_pause("SHOPKEEPER: Good luck. You are gonna need it.")
            ...
            low_gold_message()
    # if player wants to buy 'jewellary' in the Brokshop
    elif "jewellary" in Brokshop_choice:
        if gold >= 400:
            print_pause("SHOPKEEPER: You have a keen eye in arts" + player)
            print_pause("Note: You have the Jewellary in your possession")
            Brokshop_items = remove_item(Brokshop_items,
            ...
            low_gold_message()
    # if player wants to buy 'durandal' in the Brokshop
    # by adding / durandal == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "durandal" in Brokshop_choice and durandal == "available":
        if gold >= 600 and "Excaliber" not in player_items:
            print_pause("SHOPKEEPER: A great sword for the true warrior")
            print_pause("SHOPKEEPER: It is said to bring out the inner "
                        "strenth of the warrior from the depths of volcano")
            ...
            low_gold_message()
    # if player wants to buy 'tribute' in the Brokshop
    # by adding / tribute == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "tribute" in Brokshop_choice and tribute == "available":
        # if the player has 'trade contract' in his possession
        if "Trade Contract" in player_items:
            print_pause("SHOPKEEPER: You found my lost 'Trade contract' !!")
            print_pause("SHOPKEEPER: You have my thanks " + player + ".")
    ...
    # if the player does not have trade contract in his possession
            ...
            print_pause("SHOPKEEPER: Find it and the Tribute is yours")
            trade_contract_sequense = "initiated"
    # if player wants to buy 'steel helmet' in the Brokshop
    # by adding / helmet == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "helmet" in Brokshop_choice and helmet == "available":
        if gold >= 200:
            print_pause("SHOPKEEPER: Good choice, better safe than sorry.")
            print_pause("NOTE: You have accquired a 'Steel Helmet'")
            Brokshop_items = remove_item(Brokshop_items,
            ...
            low_gold_message()
    # if player wants to get back to the village
    elif "village" in Brokshop_choice:
        print_pause("You head back to the village")
        village()
    # if player gives an unrecognized input
    else:
    ...
    print_pause("\nYou took care of the business in Traven, as of now "
                "and head back to the village")
    village()
# funtion to trigger Sindrishop sequence in the game
def Sindrishop():
    global gold
     global crystal
    global metal    
    global Sindrishop_items
    global player_items
    global player
    global player_status
    global player_offense_min
    ...
    global helmet
    global gift_items
    global Sindrishop_count
    Sindrishop_count += 1
    # An introduction to be used only one time in the game
    if Sindrishop_count == 1:
        print_pause("SHOPKEEPER: Haah.., a fine warrior.")
        print_pause("SHOPKEEPER: Welcome to the Traven of trade and purchase.")
        print_pause("SHOPKEEPER: We have a large collection from far lands "
                    "of Euthopia.")
    ...
    # A message to be displayed only if the player is wanted
        ...
        print_pause("SHOPKEEPER: But I am willing to keep this as a "
                    "secret between us")
    # A message to be used throughout the game, if player revisit the Sindrishop
    else:
        print_pause("\nSHOPKEEPER: Welcome back " + player + " !!")
        print_pause("SHOPKEEPER: Back for more?")
        print_pause("SHOPKEEPER: Let me see if I can find, what you need.")
    ...
    print_pause("SHOPKEEPER: What do you want to purchase? Name it.")
    # Displays Sindrishops items in a serial list and take desired input from player
    Sindrishop_choice = input(list_serial(Sindrishop_items)).lower()
    # if player wants to buy health potion in the Sindrishop
    if "health" in Sindrishop_choice:
        if gold >= 50 and player_health < 100:
            print_pause("SHOPKEEPER: One must stock up on health or face "
                        "certain death")
            print_pause("Gold: " + str(gold) + ", - 50")
            ...
            low_gold_message()
    # if player wants to buy 'freya dress' in the Sindrishop
    # by adding /freya_dress == "available"/ in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "freya" in Sindrishop_choice and freya_dress == "available":
        if gold >= 300:
            print_pause("SHOPKEEPER: A rare robe, legend has it's "
                        "been worn by Goddess freya herself !!\n")
            print_pause("Note: Now you have 'Robes of Freya' in your "
                        "possession")
            Sindrishop_items = remove_item(Sindrishop_items,
                                     "Robes of Freya          - Worth 300$")
            player_items.append("Robes of Freya")
            gift_items.append("Robes of Freya")
            freya_dress = "not available"
            ...
            low_gold_message()
    # if player wants to buy 'princess dress' in the Sindrishop
    # by adding /princess_dress == "available"/ in below statement-
    # player cannot buy this item, if the item is already sold out
    elif "princess" in Sindrishop_choice and princess_dress == "available":
        if gold >= 500:
            print_pause("SHOPKEEPER: A fine dress! " + player)
            print_pause("SHOPKEEPER: I guess it's not for you to wear. "
                        "Hmm., a gift perhaps!!")
            ...
            low_gold_message()
    # if player wants to buy 'steel armour' in the Sindrishop
    # by adding / armour == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "armour" in Sindrishop_choice and armour == "available":
        if gold >= 400:
            print_pause("SHOPKEEPER: Shiny shiny, makes enemies whiny tiny")
            print_pause("Note: Now you have 'Steel Armour' in your possession")
            Sindrishop_items = remove_item(Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to buy 'talisman' in the Sindrishop
    elif "talisman" in Sindrishop_choice:
        if gold >= 300:
            print_pause("SHOPKEEPER: I see you are in serious "
                        "business " + player)
            print_pause("SHOPKEEPER: Good luck. You are gonna need it.")
            ...
            low_gold_message()
    # if player wants to buy 'jewellary' in the Sindrishop
    elif "jewellary" in Sindrishop_choice:
        if gold >= 400:
            print_pause("SHOPKEEPER: You have a keen eye in arts" + player)
            print_pause("Note: You have the Jewellary in your possession")
            Sindrishop_items = remove_item(Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to buy 'durandal' in the Sindrishop
    # by adding / durandal == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "durandal" in Sindrishop_choice and durandal == "available":
        if gold >= 600 and "Excaliber" not in player_items:
            print_pause("SHOPKEEPER: A great sword for the true warrior")
            print_pause("SHOPKEEPER: It is said to bring out the inner "
                        "strenth of the warrior from the depths of volcano")
            ...
            low_gold_message()
    # if player wants to buy 'tribute' in the Sindrishop
    # by adding / tribute == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "tribute" in Sindrishop_choice and tribute == "available":
        # if the player has 'trade contract' in his possession
        if "Trade Contract" in player_items:
            print_pause("SHOPKEEPER: You found my lost 'Trade contract' !!")
            print_pause("SHOPKEEPER: You have my thanks " + player + ".")
    ...
    # if the player does not have trade contract in his possession
            ...
            print_pause("SHOPKEEPER: Find it and the Tribute is yours")
            trade_contract_sequense = "initiated"
    # if player wants to buy 'steel helmet' in the Sindrishop
    # by adding / helmet == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "helmet" in Sindrishop_choice and helmet == "available":
        if gold >= 200:
            print_pause("SHOPKEEPER: Good choice, better safe than sorry.")
            print_pause("NOTE: You have accquired a 'Steel Helmet'")
            Sindrishop_items = remove_item(Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to get back to the village
    elif "village" in Sindrishop_choice:
        print_pause("You head back to the village")
        village()
    # if player gives an unrecognized input
    else:
    ...
    print_pause("\nYou took care of the business in Traven, as of now "
                "and head back to the village")
    village()
    # funtion to trigger Brok&Sindrishop sequence in the game
def Brok&Sindrishop():
    global gold
     global crystal
    global metal    
    global Brok&Sindrishop_items
    global player_items
    global player
    global player_status
    global player_offense_min
    ...
    global helmet
    global gift_items
    global Brok&Sindrishop_count
    Brok&Sindrishop_count += 1
    # An introduction to be used only one time in the game
    if Brok&Sindrishop_count == 1:
        print_pause("SHOPKEEPER: Haah.., a fine warrior.")
        print_pause("SHOPKEEPER: Welcome to the Traven of trade and purchase.")
        print_pause("SHOPKEEPER: We have a large collection from far lands "
                    "of Euthopia.")
    ...
    # A message to be displayed only if the player is wanted
        ...
        print_pause("SHOPKEEPER: But I am willing to keep this as a "
                    "secret between us")
    # A message to be used throughout the game, if player revisit the Brok&Sindrishop
    else:
        print_pause("\nSHOPKEEPER: Welcome back " + player + " !!")
        print_pause("SHOPKEEPER: Back for more?")
        print_pause("SHOPKEEPER: Let me see if I can find, what you need.")
    ...
    print_pause("SHOPKEEPER: What do you want to purchase? Name it.")
    # Displays Brok&Sindrishops items in a serial list and take desired input from player
    Brok&Sindrishop_choice = input(list_serial(Brok&Sindrishop_items)).lower()
    # if player wants to buy health potion in the Brok&Sindrishop
    if "health" in Brok&Sindrishop_choice:
        if gold >= 50 and player_health < 100:
            print_pause("SHOPKEEPER: One must stock up on health or face "
                        "certain death")
            print_pause("Gold: " + str(gold) + ", - 50")
            ...
            low_gold_message()
    # if player wants to buy 'freya dress' in the Brok&Sindrishop
    # by adding /freya_dress == "available"/ in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "freya" in Brok&Sindrishop_choice and freya_dress == "available":
        if gold >= 300:
            print_pause("SHOPKEEPER: A rare robe, legend has it's "
                        "been worn by Goddess freya herself !!\n")
            print_pause("Note: Now you have 'Robes of Freya' in your "
                        "possession")
            Brok&Sindrishop_items = remove_item(Brok&Sindrishop_items,
                                     "Robes of Freya          - Worth 300$")
            player_items.append("Robes of Freya")
            gift_items.append("Robes of Freya")
            freya_dress = "not available"
            ...
            low_gold_message()
    # if player wants to buy 'princess dress' in the Brok&Sindrishop
    # by adding /princess_dress == "available"/ in below statement-
    # player cannot buy this item, if the item is already sold out
    elif "princess" in Brok&Sindrishop_choice and princess_dress == "available":
        if gold >= 500:
            print_pause("SHOPKEEPER: A fine dress! " + player)
            print_pause("SHOPKEEPER: I guess it's not for you to wear. "
                        "Hmm., a gift perhaps!!")
            ...
            low_gold_message()
    # if player wants to buy 'steel armour' in the Brok&Sindrishop
    # by adding / armour == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "armour" in Brok&Sindrishop_choice and armour == "available":
        if gold >= 400:
            print_pause("SHOPKEEPER: Shiny shiny, makes enemies whiny tiny")
            print_pause("Note: Now you have 'Steel Armour' in your possession")
            Brok&Sindrishop_items = remove_item(Brok&Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to buy 'talisman' in the Brok&Sindrishop
    elif "talisman" in Brok&Sindrishop_choice:
        if gold >= 300:
            print_pause("SHOPKEEPER: I see you are in serious "
                        "business " + player)
            print_pause("SHOPKEEPER: Good luck. You are gonna need it.")
            ...
            low_gold_message()
    # if player wants to buy 'jewellary' in the Brok&Sindrishop
    elif "jewellary" in Brok&Sindrishop_choice:
        if gold >= 400:
            print_pause("SHOPKEEPER: You have a keen eye in arts" + player)
            print_pause("Note: You have the Jewellary in your possession")
            Brok&Sindrishop_items = remove_item(Brok&Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to buy 'durandal' in the Brok&Sindrishop
    # by adding / durandal == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "durandal" in Brok&Sindrishop_choice and durandal == "available":
        if gold >= 600 and "Excaliber" not in player_items:
            print_pause("SHOPKEEPER: A great sword for the true warrior")
            print_pause("SHOPKEEPER: It is said to bring out the inner "
                        "strenth of the warrior from the depths of volcano")
            ...
            low_gold_message()
    # if player wants to buy 'tribute' in the Brok&Sindrishop
    # by adding / tribute == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "tribute" in Brok&Sindrishop_choice and tribute == "available":
        # if the player has 'trade contract' in his possession
        if "Trade Contract" in player_items:
            print_pause("SHOPKEEPER: You found my lost 'Trade contract' !!")
            print_pause("SHOPKEEPER: You have my thanks " + player + ".")
    ...
    # if the player does not have trade contract in his possession
            ...
            print_pause("SHOPKEEPER: Find it and the Tribute is yours")
            trade_contract_sequense = "initiated"
    # if player wants to buy 'steel helmet' in the Brok&Sindrishop
    # by adding / helmet == "available" / in the below statement-
    # player cannot buy this item, if the item is already sold out
    elif "helmet" in Brok&Sindrishop_choice and helmet == "available":
        if gold >= 200:
            print_pause("SHOPKEEPER: Good choice, better safe than sorry.")
            print_pause("NOTE: You have accquired a 'Steel Helmet'")
            Brok&Sindrishop_items = remove_item(Brok&Sindrishop_items,
            ...
            low_gold_message()
    # if player wants to get back to the village
    elif "village" in Brok&Sindrishop_choice:
        print_pause("You head back to the village")
        village()
    # if player gives an unrecognized input
    else:
...
def game_day():
    ...
    # if player wants to leave the contest grounds
        ...
        village()
####
# funtion to trigger the location 'Arena' in the village
def Arena():
    global time_zone
    global contest_day_count
    global contest_night_count
    # if player visits 'Arena' during daytime
    if time_zone == "day":
        contest_day_count += 1
        # intro to be used only once in the game
        if contest_day_count == 1:
        ...
        if contest_day_count >= 1:
            ...
            # condition to handle unrecognized inputs from the player
                ...
                print_pause("HOST: Make up your mind stranger. 'yes' "
                            "or 'no' ?")
                Arena()
    # if player visits 'Arena' during night time
    elif time_zone == "night":
        contest_night_count += 1
        # intro to be used only once in the game
        if contest_night_count == 1:
...
# A branch sequence to the funtion 'Arena'
def game_day():
    global gold
    global contest_items
    global rewards_day
    ...
    if player_status == "wanted":
        print_pause("Leave stranger, you are gonna get me in trouble")
        print_pause("You are forced to leave the Arena")
        print_pause("You head back to the village")
        village()
    # choice to play different games
    print_pause("\nHOST: welcome stranger, what would you like to play?")
    ...
    if "yes" in play_again:
        game_day()
    # if player wants to leave the Arena
    else:
        print_pause("HOST: Good bye, stranger")
        village()
...
def game_night_contest():
    ...
    if "gladiator" in contest_night_choice:
        ...
        print_pause("HOST: He is the best fighter around "
                    "all the nearby villages of the 9 realms")
    ...
    for turn in range(40):
        ...
        # if player loses the battle
            ...
            if enemy == "warrior" or enemy == "gladiator":
                ...
                print_pause("Your Health: " + str(player_health) + "\n")
                return "enemy wins"
            # if the fight is not in the Arena
            # game ends
            print_pause("You are dead.")
            game_over = "activate"
            village()
...
######
# funtion to trigger the location 'dungon' in the city
def dungon():
    global dungon_trigger
    global time_zone
    global player_items
    # if player got tired from exploring dungon
    if dungon_trigger == "activate":
        print_pause("You are tired, comeback tomorrow")
        city()
    # if player tries to enter dungon at night time
    if time_zone == "night":
        # player must have a fire element to enter dungon at night time
        if "Talisman" in player_items:
            print_pause("You venture into the dungon tearing the shadows"
                        " with your fire element.")
            dungon_choice()
        # if player does not have a fire element, he must be rejected
        else:
            print_pause("The dungon is dark and dangerous at night")
            print_pause("You need a light source to move forward")
            print_pause("You head back to the city")
            city()
    # if player enters dungon at daytime
    # as we bypassed night time conditional statement,
    # no conditional statement is required to specify day time trigger
    print_pause("You venture deep into the dungon")
    print_pause("The dungon is vast and home to all kinds of things."
                " This includes wild animals")
    dungon_choice()


# A branch sequence to the funtion 'dungon'
def dungon_choice():
    global time_zone
    global player_items
    global gift_items
    ...
    print_pause("\nEnter the number to perform the desired action:")
    dungon_action = input("1. Flowers"
                          "\n2. Grapes"
                          "\n3. Explore"
                          "\n4. Go back to city\n")
    # if player chooses to collect flowers during daytime
    if dungon_action == "1" and time_zone == "day":
        # if player already possess flowers in his items
        if "Flowers" in player_items:
            print_pause("You already have flowers in your inventory")
            dungon_choice()
    ...
    # if player chooses to collect flowers during daytime
    # flowers are replaced bu glowing blossom during night time
    elif dungon_action == "1" and time_zone == "night":
        # if player already possess glowing blossom in his items
        if "Glowing Blossom" in player_items:
            print_pause("You already have glowing blossom in your inventory")
            dungon_choice()
    ...
    # if player chooses to collect grapes irrespective of time
        ...
        # if player does not possess grapes in his items
            ...
            gift_items.append("Grapes")
            dungon_choice()
    # if player chooses to explore dungon irrespective of time
    elif dungon_action == "3":
        print_pause("NOTE: The dungon is vast")
        print_pause("Enter the number of the location, you want to search:")
        dungon_explore()
    # if player chooses to return to the city
    elif dungon_action == "4":
        print_pause("You head back to the city")
        city()
    # condition to deal unrecognized input
    else:
...
# A branch sequence to the funtion 'dungon_choice'
def dungon_explore():
    global player_items
    global dungon_explore_count
    global dungon_trigger
    global animal_list
    global strong_animal_list
    # animal attack triggers at random with a probability of '1/4'
    ...
    if animal_attack == "yes":
        ...
        if fight_result == "player wins":
            ...
            print_pause("You resume your search")
        # if player loses, the sequence is executed in 'fight_sequence'
    # allows the player to enter an input to explore the dungon
    dungon_explore_action = int(input("Location : "))
    dungon_explore_count += 1
    # if exlpore input/count is given more than 3 times,
    # player is restricted to enter untill the next day
    if dungon_explore_count > 3:
        print_pause("You are tired, come back tomorrow")
        print_pause("You have returned back to the city")
        dungon_trigger = "activate"
        city()
    if dungon_explore_action >= 1 and dungon_explore_action < 20:
        print_pause("NOTE: You find nothing in this location, "
                    "better look somewhere else")
    elif dungon_explore_action >= 20 and dungon_explore_action < 25:
        print_pause("NOTE: You sense something not far from here")
    elif dungon_explore_action >= 25 and dungon_explore_action < 28:
        print_pause("NOTE: You are close to finding something")
    elif dungon_explore_action == 28:
        print_pause("You found the 'Lost Tomb of King Authur'")
        print_pause("The tomb is sealed off and require a keyword password")
        tomb()
    elif dungon_explore_action > 28 and dungon_explore_action <= 32:
        print_pause("NOTE: You are close to finding something")
    elif dungon_explore_action > 32 and dungon_explore_action <= 36:
        print_pause("NOTE: You sense something not far from here")
    elif dungon_explore_action > 36:
        print_pause("NOTE: You find nothing in this location, "
                    "better look somewhere else")
    # condition to loop back to explore option
    else:
...
# A branch sequence to the funtion 'dungon_explore'
def tomb():
    global player_items
    global player_offense_min
    global player_offense_max
    ...
    if tomb_keyword == "Vamshi Krishna P":
        ...
        print_pause("\nNOTE: Your offense has increased "
                    "to: " + str(player_offense_max))
        print_pause("NOTE: You are stronger than ever")
        print_pause("You now head back to the city")
        city()
    # if the keyword input is not matched
    else:
        Keyword_count += 1
...
# funtion to trigger the location 'castle' in the village
def castle():
    global player_items
    global castle_count
    global gold
    ...
    castle_count += 1
    # if player tries to enter castle at night time, he should be restricted
    if time_zone == "night":
        print_pause("The access to castle is restricted at night time")
        print_pause("Come back later")
        print_pause("You head back to the village")
        village()
    # if kings identity is revealed to the player, player should be
    # allowed into the castle even if the player is wanted for the crime
    if kings_status == "revealed":
        print_pause("You enter the castle demading a meeting with the king")
        print_pause("You were allowed inside the inner halls of the castle")
        inner_castle()
    # player will be imprisoned, if he tries to
    # enter the castle and is wanted foe a crime
    if player_status == "wanted":
        ...
        prison()
    # if castle access is already granted to the player by the king
    if castle_access == "granted":
        print_pause("You have entered inside the castle")
        inner_castle()
    # if player enter the castle gates for the first time
    if castle_count == 1:
        print_pause("The village has a Magnificient Gaint Fortress "
                    "made of stone")
        print_pause("You entered the castle entrance in astonishment "
        ...
        print_pause("MINISTER: But I will make an exemption for 500 gold, "
                    "what do you say :")
    # if player enters the castle gate more than once
    if castle_count > 1:
        print_pause("\nYou are at the castle gate")
        ...
        if toll_status == "paid" and "A Grand Tribute" in player_items:
            ...
            print_pause("You head inside the castle")
            inner_castle()
    ...
    # prompted to pay the toll on first visit to the castle gate
    ...
    if "gold" in toll:
        ...
        if "A Grand Tribute" in player_items:
            ...
            print_pause("You were allowed inside the castle")
            inner_castle()
...
# A branch sequence to the funtion 'castle'
def inner_castle():
    global player_items
    global time_zone
    global inner_castle_count
    global bell
    global castle_access
    ...
    if time_zone == "day":
        inner_castle_choice = input(list_serial(castle_locations_day)).lower()
    # displays different list of locations in a serial, during night time
    elif time_zone == "night":
        inner_castle_choice = input(list_serial(castle_locations_night)).lower()
    # if player enters central hall during daytime
    if "hall" in inner_castle_choice and time_zone == "day":
        inner_castle_count += 1
        # intro to be triggered only once
        if inner_castle_count == 1:
            ...
            print_pause("The king is pleased to the gift and welcomes "
                        "you to his castle")
            print_pause("\nNOTE: You gain access to the castle")
            print_pause("NOTE: You gain access to the 'Library' and 'Garden'")
            # trigger to give access to the castle
            castle_access = "granted"
            inner_castle()
    ...
    # if player enters central hall during night time
    elif "hall" in inner_castle_choice and time_zone == "night":
        ...
        if "bell" in hall_choice:
            ...
            print_pause("The sound of the bell echoes throught out the castle")
        ...
        # if player chooses to not to create a distraction
            ...
            print_pause("You head back to the inner castle")
            inner_castle()
        # condition to deal with unrecognized input
        else:
    ...
    # if player chooses to enter the library
    elif "library" in inner_castle_choice:
        ...
        if library_status == "burnt":
            ...
            print_pause("You head back to inner halls of castle")
            inner_castle()
        if time_zone == "night":
            # if gaurds are alerted
            if bell == "activated":
            ...
            elif "castle" in library_choice:
                print_pause("\nIt is wise to consider other options")
                print_pause("You head back to inner halls of the castle")
                inner_castle()
            # condition to deal with unrecognized input
            else:
                print_pause("\nEnter the correct words next time")
                print_pause("You were sent back to inner halls of the castle")
                inner_castle()
        ...
        if castle_access == "granted":
            ...
            # if player wants to study about the castle
            elif "castle" in library_study:
                print_pause("\nThe castle is old and aged over 200 years old")
                print_pause("It has been built as a military post to overwatch"
                            " any enemy activities")
                print_pause("The castle has withstood many seizes and "
                            "weather conditions")
            ...
            room()
        # if castle access is not given to the player
        elif castle_access != "granted":
            print_pause("\nLibrary is not accessable to everyone !")
            print_pause("You need permit from the king himself")
            print_pause("You were sent back to the inner halls of the castle")
            inner_castle()

    # if player chooses to enter the garden
    elif "garden" in inner_castle_choice:
        ...
        if time_zone == "night":
            ...
            # if player wants to enter castle
            if "castle" in garden_choice:
                print_pause("\nYou sneaks into the inner halls of castle")
                inner_castle()
            ...
            # condition to deal with unrecognized input
                ...
                inner_castle()
        # if castle/garden access was not granted to the player
        if castle_access != "granted":
            print_pause("\nThe garden area is restricted to strangers")
            print_pause("You need permit from the king himself")
            print_pause("You were sent back to the inner halls of the castle")
            inner_castle()
        # if castle/garden access is granted to the player
        elif castle_access == "granted" and time_zone == "day":
    ...
    # if player chooses to enter the quaters
    elif "quaters" in inner_castle_choice:
        ...
        if time_zone == "night":
            ...
            royal_quaters()
    # if player chooses to return to the village
    elif "village" in inner_castle_choice:
        print_pause("You head back to the village")
        village()
    # condition to deal with unrecognized input
    else:
...
# A branch sequence to the funtion 'inner_castle'
def royal_quaters():
    global bell
    global player_items
    # player's choice
    ...
    if "king" in royal_quaters_choice:
        ...
        if bell == "activated":
            ...
            print_pause("NOTE: It is adviced to leave the castle for the day")
            print_pause("You head back to the inner halls of castle")
            inner_castle()
    ...
    # if player chooses to sneak into princess quaters
        ...
        print_pause("You head back to the inner halls")
        inner_castle()
    # if player chooses to return to the castle
    elif "castle" in royal_quaters_choice:
        print_pause("\nYou head back to the inner halls of the castle")
        inner_castle()
    # condition to deal with unrecognized input
    else:
    ...
    if kings_quaters_choice == "1":
        ...
        # if player chooses not to take take the risk
            ...
            print_pause("\nYou avoided getting caught by withdrawing from "
                        "the room")
            print_pause("You head back to the inner halls of the castle")
...
def princess():
    ...
    if "talk" in princess_choice:
        ...
        if princess_quest_status == "completed":
            ...
            print_pause("After a while you head back to the inner castle area")
            inner_castle()
        ...
        princess_quest()
    # if player wishes not to talk to the princess and return to castle
    elif "castle" in princess_choice:
        print_pause("You head back to the inner halls of the castle")
        inner_castle()
    # condition to deal with unrecognized input
    else:
...
def princess_quest():
   ...
   global zones_locations
   global worlds_locations
    global realms_locations
    global regions_locations
    global countries_locations
    global continets_locations
    global kingdoms_locations
 ...
 #####
 # A branch sequence to the funtion 'npc'
def npc_quest():
    global player_items
    global gift_items
    global npc_items
    global player
    global npc_quest_status
    global village_locations
   global zones_locations
   global worlds_locations
    global realms_locations
    ...
    # if npc accepted more than 2 gifts from the player
    # she ask for a quest
    if len(npc_items) == 3 and npc_quest_status != "completed":
        # if quest is completed
        if "Royal Locket" in player_items:
            print_pause("\nPRINCESS: You brought back the Royal Locket !!")
            print_pause("PRINCESS: Thank you " + player + " !! , This means a "
                        "lot to me")
            print_pause("PRINCESS: How could I repay you ?!")
            print_pause(player + " : It is my duty, npc. I will help you"
                        " however I could")
            player_items = remove_item(player_items, "Royal Locket")
            npc_items.append("Royal Locket")
            npc_quest_status = "completed"
            print_pause("PRINCESS: As a gratitude, let me tell you a secret")
            print_pause("PRINCESS: There ia a secret passage in this garden"
                        " which leads to the village")
            print_pause("PRINCESS: Only the royal members of the kingdom are"
                        " known about this passage")
            print_pause("PRINCESS: Perhaps it might help you !!\n")
            print_pause("The npc then leaves the garden in exitement")
            print_pause("NOTE: Princess forgot to take back "
                        "the 'Empress Sigil' from you")
            print_pause("NOTE: Perhaps it might come in handy later !?")
            print_pause("NOTE: The 'Royal Locket' has been removed from "
    ...
    # if npcs quest is does not meet required conditions to get triggered
    # and player wants to give gift to the npc
    print_pause("\nWhat do you choose to offer ?")
    # if player does not have anything to offer to the npcs
    # / len(gift_items) == 1 / is used because / leave / option
    # is used inside gift list
    if len(gift_items) == 1:
        print_pause("\nNOTE:You have nothing to offer to the npc")
        print_pause("NOTE: Come back later")
        print_pause("You head back to the inner halls")
        inner_fort()
    # displays list of gift items in a serial list
    npc_choice = input(list_serial(gift_items)).lower()
    # if player wants to gift flowers and have them in his possession
    if "flowers" in npc_choice and "Flowers" in gift_items:
        print_pause("PRINCESS: Beautiful flowers but nothing I haven't "
                    "seen in this garden")
        player_items = remove_item(player_items, "Flowers")
        gift_items = remove_item(gift_items, "Flowers")
        ...
        npc_quest()
    # if player wants to gift glowing blossom and have them in his possession
    elif "glowing" in npc_choice and "Glowing Blossom" in gift_items:
        print_pause("PRINCESS: I have never seen a flower of this kind")
        print_pause("PRINCESS: Thank you " + player)
        player_items = remove_item(player_items, "Glowing Blossom")
        gift_items = remove_item(gift_items, "Glowing Blossom")
        print_pause("NOTE: 'Glowing Blossom' has been removed from your "
                    "possession\n")
        # if npc do not have them in her possession
        # she consider them as a gift item
        if "Glowing Blossom" not in npc_items:
            npc_items.append("Glowing Blossom")
            print_pause("NOTE: You relationship strengthened")
        npc_quest()
    # if player wants to gift freya dress and have them in his possession
    elif "freya" in npc_choice and "Robes of Freya" in gift_items:
        print_pause("PRINCESS: Odd dress !!, though unique it is not to "
                    "my taste")
        player_items = remove_item(player_items, "Robes of Freya")
        gift_items = remove_item(gift_items, "Robes of Freya")
        print_pause("NOTE: 'Robes of Freya' has been removed from your "
                    "possession\n")
        npc_quest()
    # if player wants to gift npc dress and have them in his possession
    elif "npc" in npc_choice and "Dress of a npc" in gift_items:
        print_pause("PRINCESS: Elegent dress, I like it " + player)
        player_items = remove_item(player_items, "Dress of a npc")
        gift_items = remove_item(gift_items, "Dress of a npc")
        print_pause("NOTE: 'Dress of a npc' has been removed from "
                    "your possession\n")
        npc_quest()
    # if player wants to gift steel armour and have them in his possession
    elif "armour" in npc_choice:
        if "Glittering steel armour" in gift_items:
            print_pause("PRINCESS: Thank you very much " + player + " !!")
            print_pause("PRINCESS: I always wanted to try one of these")
            print_pause("PRINCESS: But my father never let me")
            ...
            # if npc do not have them in her possession
            # she consider them as a gift item
            if "Glittering steel armour" not in npc_items:
                npc_items.append("Glittering steel armour")
                print_pause("NOTE: You relationship strengthened")
        else:
            print_pause("you do not have Glittering steel armour")
        npc_quest()
    # if player wants to gift grapes and have them in his possession
    elif "grapes" in npc_choice and "Grapes" in gift_items:
        print_pause("PRINCESS: I appreciate the intention but I am not "
                    "hungry now")
        player_items = remove_item(player_items, "Grapes")
        gift_items = remove_item(gift_items, "Grapes")
        ...
        npc_quest()
    # if player wants to gift jewellary and have them in his possession
    elif "jewellary" in npc_choice and "Jewellary" in gift_items:
        print_pause("PRINCESS: Splendid jewellary !!")
        print_pause("PRINCESS: Perhaps I will wear it for our next meeting")
        player_items = remove_item(player_items, "Jewellary")
        gift_items = remove_item(gift_items, "Jewellary")
        ...
        # if npc do not have them in her possession
        # she consider them as a gift item
        if "Jewellary" not in npc_items:
            npc_items.append("Jewellary")
            print_pause("NOTE: You relationship strengthened")
        npc_quest()
    # if player chooses to leave the garden
    elif "leave" in npc_choice:
        print_pause("You head back to the inner halls")
        inner_fort()
    # condition to deal with unrecognized input
    else:
...
def kings_fate_scenario():
    ...
    # if player decides not to kill the king
        ...
        if fight_result == "player wins":
            ...
            print_pause("The 9 realms of Asgurd are save from Evil Darkness Of The Elf Lords")
